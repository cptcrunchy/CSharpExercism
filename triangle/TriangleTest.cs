...
public class TriangleTest
{
    ...
    [Fact]
    public void Degenerate_triangle_first_and_second_sides_equal_last_side()
    {
      Assert.True(Triangle.IsDegenerate(1, 1, 2));
    }
    [Fact]
    public void Degenerate_triangle_first_and_second_sides_not_equal_last_side()
    {
      Assert.False(Triangle.IsDegenerate(1, 1, 2.1));
    }
    [Fact]
    public void Degenerate_triangle_first_and_last_sides_equal_second_side()
    {
      Assert.True(Triangle.IsDegenerate(2.5, 5, 2.5));
    }
    [Fact]
    public void Degenerate_triangle_last_and_second_sides_equal_first_side()
    {
      Assert.True(Triangle.IsDegenerate(4, 2, 2));
    }
}